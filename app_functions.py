...
def print_correct_answer(die_1_value, die_2_value, question_type):
    ...
    # complete this function below here
    if question_type == "sum":
        correct_anwser = die_1_value + die_2_value
        print("No! The sum of {} and {} is {}!".format(die_1_value, die_2_value, correct_anwser))
    else:
        correct_anwser = abs(die_1_value - die_2_value)
        print("No! The difference between {} and {} is {}!".format(die_1_value, die_2_value, correct_anwser))
